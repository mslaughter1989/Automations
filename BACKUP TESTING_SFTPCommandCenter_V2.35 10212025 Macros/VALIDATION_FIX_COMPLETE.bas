...
Public Sub ValidateField(vFieldValue As Variant, sFieldType As String, _
    ...
    ' Module-level variables for tracking validation checks
    ...
    If Not validationCounts.Exists(sFieldType) Then
        Set validationCounts(sFieldType) = CreateObject("Scripting.Dictionary")
    ...
    Dim bFirstCheck As Boolean
    bFirstCheck = (Err.Number = 0)
    On Error GoTo 0
